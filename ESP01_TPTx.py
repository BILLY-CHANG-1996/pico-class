...
lens = len('GET /update?api_key=DF1RSBS2OCUxxxxx&field1="+temp+"\r\n')
Len = str(lens)
print(lens)
utime.sleep(1)
#functions
...
sendCMD_waitResp('AT+CWJAP="PengiPhone","ts650650650"\r\n', 5000) #connecting
...
while True:
    ...
    sendCMD_waitResp("GET /update?api_key=UXXW3Q7SWDB6ZVRA&field1="+temp+"&field2= "+humi+"\r\n")
